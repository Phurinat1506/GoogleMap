...
snmp_get(UdpTransportTarget(('172.30.201.34', 161)),ObjectType(ObjectIdentity('.1.3.6.1.2.1.2.2.1.1')))
status_BOTANICFL1SW238 = check_status_sw(info_SW[1])

while(status_BOTANICFL1SW238 != 0):
    snmp_get(UdpTransportTarget(('172.30.201.34', 161)),ObjectType(ObjectIdentity('.1.3.6.1.2.1.1.5.0'))) 
    name_BOTANICFL1SW238=info_SW[1]

    snmp_get(UdpTransportTarget(('172.30.201.34', 161)),ObjectType(ObjectIdentity('.1.3.6.1.2.1.4.20.1.1.172.30.201.34')))
    ip_BOTANICFL1SW238=info_SW[1]    
    
    snmp_get(UdpTransportTarget(('172.30.201.34', 161)),ObjectType(ObjectIdentity('.1.3.6.1.4.1.9.2.1.57.0')))
    cpu_BOTANICFL1SW238=info_SW[1]    

    snmp_get(UdpTransportTarget(('172.30.201.34', 161)),ObjectType(ObjectIdentity('.1.3.6.1.2.1.2.2.1.2.10')))
    portInbound_port_BOTANICFL1SW238 = info_SW[1]

    snmp_get(UdpTransportTarget(('172.30.201.34', 161)),ObjectType(ObjectIdentity('.1.3.6.1.4.1.9.2.2.1.1.6.10')))
    ...
    snmp_get(UdpTransportTarget(('172.30.201.34', 161)),ObjectType(ObjectIdentity('.1.3.6.1.4.1.9.2.2.1.1.8.10')))
    ...
    snmp_get(UdpTransportTarget(('172.30.201.34', 161)),ObjectType(ObjectIdentity('.1.3.6.1.2.1.1.3.0')))
    log_BOTANICFL1SW238 = uptime(info_SW[1])  
 
    snmp_getnext(UdpTransportTarget(('172.30.201.34', 161)),ObjectType(ObjectIdentity('.1.3.6.1.4.1.9.9.23.1.2.1.1.6')))
...
BOTANICFL1SW238.insert_SW("BOTANICFL1SW238",20.050673, 99.892090)# 3 arguments
...
BOTANICFL1SW238.update_Location("BOTANICFL1SW238",20.050673, 99.892090)# 3 arguments
