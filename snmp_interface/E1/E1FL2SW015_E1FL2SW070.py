...
INTERFACE_E1FL2SW015_E1FL2SW070 = Interfaces(name_E1FL2SW015,interface_E1FL2SW015,name_E1FL2SW070,interface_E1FL2SW070)
while(status_E1FL2SW015 != 0 or status_E1FL2SW070 != 0):
    ...
    snmp_get(UdpTransportTarget(('172.30.200.45', 161)),ObjectType(ObjectIdentity('.1.3.6.1.2.1.2.2.1.2.9'))  )
    interfaceName_E1FL2SW070 = info_SW[1]
    snmp_get(UdpTransportTarget(('172.30.200.45', 161)),ObjectType(ObjectIdentity('.1.3.6.1.2.1.2.2.1.7.9'))  )
    interfaceStatus_E1FL2SW070 = info_SW[1]
    interface_E1FL2SW070 = state_name(interfaceName_E1FL2SW070) +":"+ state_port(interfaceStatus_E1FL2SW070)
    
    
    UPDATE_INT = [name_E1FL2SW015,interface_E1FL2SW015,name_E1FL2SW070,interface_E1FL2SW070]# 2 arguments
    INTERFACE_E1FL2SW015_E1FL2SW070.insert_INT("E1FL2SW015_E1FL2SW070",20.045594, 99.893632,20.045409, 99.893615)# 5 arguments
    INTERFACE_E1FL2SW015_E1FL2SW070.update_Point("E1FL2SW015_E1FL2SW070",20.045594, 99.893632,20.045409, 99.893615)# 5 arguments
    INTERFACE_E1FL2SW015_E1FL2SW070.update_INT("E1FL2SW015_E1FL2SW070",UPDATE_INT)# 2 arguments
    break
...
while(status_E1FL2SW015 == 0 or status_E1FL2SW070 == 0):
    interface_E1FL2SW015 = info_SW
    interface_E1FL2SW070 = info_SW
    INTERFACE_E1FL2SW015_E1FL2SW070.delete_INT("E1FL2SW015_E1FL2SW070")# 1 arguments
    break
