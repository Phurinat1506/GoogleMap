...
INTERFACE_E2FL2SW016_E2FL2SW075 = Interfaces(name_E2FL2SW016,interface_E2FL2SW016,name_E2FL2SW075,interface_E2FL2SW075)
while(status_E2FL2SW016 != 0 or status_E2FL2SW075 != 0):
    ...
    snmp_get(UdpTransportTarget(('172.30.200.54', 161)),ObjectType(ObjectIdentity('.1.3.6.1.2.1.2.2.1.2.9'))  )
    interfaceName_E2FL2SW075 = info_SW[1]
    snmp_get(UdpTransportTarget(('172.30.200.54', 161)),ObjectType(ObjectIdentity('.1.3.6.1.2.1.2.2.1.7.9'))  )
    interfaceStatus_E2FL2SW075 = info_SW[1]
    interface_E2FL2SW075 = state_name(interfaceName_E2FL2SW075) +":"+ state_port(interfaceStatus_E2FL2SW075)
    
    
    UPDATE_INT = [name_E2FL2SW016,interface_E2FL2SW016,name_E2FL2SW075,interface_E2FL2SW075]# 2 arguments
    INTERFACE_E2FL2SW016_E2FL2SW075.insert_INT("E2FL2SW016_E2FL2SW075",20.044349, 99.893669,20.044133, 99.893538)# 5 arguments
    INTERFACE_E2FL2SW016_E2FL2SW075.update_Point("E2FL2SW016_E2FL2SW075",20.044349, 99.893669,20.044133, 99.893538)# 5 arguments
    INTERFACE_E2FL2SW016_E2FL2SW075.update_INT("E2FL2SW016_E2FL2SW075",UPDATE_INT)# 2 arguments
    break
...
while(status_E2FL2SW016 == 0 or status_E2FL2SW075 == 0):
    interface_E2FL2SW016 = info_SW
    interface_E2FL2SW075 = info_SW
    INTERFACE_E2FL2SW016_E2FL2SW075.delete_INT("E2FL2SW016_E2FL2SW075")# 1 arguments
    break
