...
INTERFACE_S7AFL1SW009_ASFL3SW001 = Interfaces(name_S7AFL1SW009,interface_S7AFL1SW009,name_ASFL3SW001,interface_ASFL3SW001)
while(status_S7AFL1SW009 != 0 or status_ASFL3SW001 != 0):
    ...
    UPDATE_INT = [name_S7AFL1SW009,interface_S7AFL1SW009,name_ASFL3SW001,interface_ASFL3SW001]# 2 arguments
    INTERFACE_S7AFL1SW009_ASFL3SW001.insert_INT("S7AFL1SW009_ASFL3SW001",20.048081, 99.895151,20.046154, 99.893680)# 5 arguments
    INTERFACE_S7AFL1SW009_ASFL3SW001.update_Point("S7AFL1SW009_ASFL3SW001",20.048081, 99.895151,20.046154, 99.893680)# 5 arguments
    INTERFACE_S7AFL1SW009_ASFL3SW001.update_INT("S7AFL1SW009_ASFL3SW001",UPDATE_INT)# 2 arguments
    break
...
while(status_S7AFL1SW009 == 0 or status_ASFL3SW001 == 0):
    interface_S7AFL1SW009 = info_SW
    interface_ASFL3SW001 = info_SW
    INTERFACE_S7AFL1SW009_ASFL3SW001.delete_INT("S7AFL1SW009_ASFL3SW001")# 1 arguments
    break
