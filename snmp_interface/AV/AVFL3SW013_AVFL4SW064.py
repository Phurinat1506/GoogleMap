...
INTERFACE_AVFL3SW013_AVFL4SW064 = Interfaces(name_AVFL3SW013,interface_AVFL3SW013,name_AVFL4SW064,interface_AVFL4SW064)
while(status_AVFL3SW013 != 0 or status_AVFL4SW064 != 0):
    ...
    snmp_get(UdpTransportTarget(('172.30.200.24', 161)),ObjectType(ObjectIdentity('.1.3.6.1.2.1.2.2.1.2.9'))  )
    interfaceName_AVFL4SW064 = info_SW[1]
    snmp_get(UdpTransportTarget(('172.30.200.24', 161)),ObjectType(ObjectIdentity('.1.3.6.1.2.1.2.2.1.7.9'))  )
    interfaceStatus_AVFL4SW064 = info_SW[1]
    interface_AVFL4SW064 = state_name(interfaceName_AVFL4SW064) +":"+ state_port(interfaceStatus_AVFL4SW064)
    
    
    UPDATE_INT = [name_AVFL3SW013,interface_AVFL3SW013,name_AVFL4SW064,interface_AVFL4SW064]# 2 arguments
    INTERFACE_AVFL3SW013_AVFL4SW064.insert_INT("AVFL3SW013_AVFL4SW064",20.046865, 99.893274,20.046388, 99.893462)# 5 arguments
    INTERFACE_AVFL3SW013_AVFL4SW064.update_Point("AVFL3SW013_AVFL4SW064",20.046865, 99.893274,20.046388, 99.893462)# 5 arguments
    INTERFACE_AVFL3SW013_AVFL4SW064.update_INT("AVFL3SW013_AVFL4SW064",UPDATE_INT)# 2 arguments
    break
...
while(status_AVFL3SW013 == 0 or status_AVFL4SW064 == 0):
    interface_AVFL3SW013 = info_SW
    interface_AVFL4SW064 = info_SW
    INTERFACE_AVFL3SW013_AVFL4SW064.delete_INT("AVFL3SW013_AVFL4SW064")# 1 arguments
    break
