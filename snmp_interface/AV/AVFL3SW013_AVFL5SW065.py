...
INTERFACE_AVFL3SW013_AVFL5SW065 = Interfaces(name_AVFL3SW013,interface_AVFL3SW013,name_AVFL5SW065,interface_AVFL5SW065)
while(status_AVFL3SW013 != 0 or status_AVFL5SW065 != 0):
    ...
    snmp_get(UdpTransportTarget(('172.30.200.25', 161)),ObjectType(ObjectIdentity('.1.3.6.1.2.1.2.2.1.2.9'))  )
    interfaceName_AVFL5SW065 = info_SW[1]
    snmp_get(UdpTransportTarget(('172.30.200.25', 161)),ObjectType(ObjectIdentity('.1.3.6.1.2.1.2.2.1.7.9'))  )
    interfaceStatus_AVFL5SW065 = info_SW[1]
    interface_AVFL5SW065 = state_name(interfaceName_AVFL5SW065) +":"+ state_port(interfaceStatus_AVFL5SW065)
    
    
    UPDATE_INT = [name_AVFL3SW013,interface_AVFL3SW013,name_AVFL5SW065,interface_AVFL5SW065]# 2 arguments
    INTERFACE_AVFL3SW013_AVFL5SW065.insert_INT("AVFL3SW013_AVFL5SW065",20.046865, 99.893274,20.046507, 99.893754)# 5 arguments
    INTERFACE_AVFL3SW013_AVFL5SW065.update_Point("AVFL3SW013_AVFL5SW065",20.046865, 99.893274,20.046507, 99.893754)# 5 arguments
    INTERFACE_AVFL3SW013_AVFL5SW065.update_INT("AVFL3SW013_AVFL5SW065",UPDATE_INT)# 2 arguments
    break
...
while(status_AVFL3SW013 == 0 or status_AVFL5SW065 == 0):
    interface_AVFL3SW013 = info_SW
    interface_AVFL5SW065 = info_SW
    INTERFACE_AVFL3SW013_AVFL5SW065.delete_INT("AVFL3SW013_AVFL5SW065")# 1 arguments
    break
